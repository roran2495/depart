    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        void Attack()
        {
            if (Input.GetKeyDown(KeyCode.K))
            {
                ...
                Vector3 positionTmp = new Vector3(transform.position.x + direction * 2f, 5f, 0);
                positionTmp.x += direction * 2f;
                // 实例化小球预制体
                GameObject ball = Instantiate(ballPrefab, positionTmp, Quaternion.identity);
            }
        }
        void Hurt()
        {
